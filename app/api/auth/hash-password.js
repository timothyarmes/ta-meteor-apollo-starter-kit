...
function SHA256(s) {
  ...
  function coreSha256(m, l) {
    ...
    m[l >> 5] |= 0x80 << (24 - l % 32); // eslint-disable-line
    m[((l + 64 >> 9) << 4) + 15] = l;   // eslint-disable-line
  ...
  const utf8s = Utf8Encode(s);
  return binb2hex(coreSha256(str2binb(utf8s), utf8s.length * chrsz));
}
